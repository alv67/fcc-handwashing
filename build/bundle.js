var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-157zeis");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-157zeis");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-nwah0i");
    			attr(div, "bp", "grid");
    			attr(button, "class", "start svelte-nwah0i");
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="lavarsilemani.png" alt="Come lavarsi le mani" class="svelte-ymdsrp"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "Lavarsi le mani";
    			t1 = space();
    			...
    			h3.innerHTML = `<a href="https://www.salute.gov.it/imgs/C_17_opuscoliPoster_193_allegato.pdf">sorgente immagine</a> 
